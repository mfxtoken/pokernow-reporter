  ...
  return (
    <div className={`min-h-screen transition-colors duration-300 ${darkMode ? 'dark bg-gray-900' : 'bg-gray-50'}`}>
      <div className="max-w-6xl mx-auto p-4 sm:p-6 space-y-6 sm:space-y-8">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-gradient-to-r from-blue-600 to-indigo-700 p-6 rounded-2xl shadow-lg text-white">
          <div>
            <h1 className="text-3xl sm:text-4xl font-black tracking-tight flex items-center gap-3">
              <Trophy className="text-yellow-300" size={32} />
              PokerNow Reporter
            </h1>
            <p className="text-blue-100 mt-1 font-medium">Track your weekly gains & settlements</p>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-3 w-full sm:w-auto">
            ...
            {isCloudConnected && (
              <button
                ...
                disabled={isSyncing}
                className={`px-4 py-2 bg-white/20 hover:bg-white/30 rounded-lg flex items-center gap-2 font-semibold transition-colors ${isSyncing ? 'opacity-50 cursor-not-allowed' : ''}`}
              >
                {isSyncing ? (
